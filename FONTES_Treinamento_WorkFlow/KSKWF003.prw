...
//    oHtml:ValByName( 'COMPRADOR'        , UsrRetName(SC7->C7_USER) )
  ...
  If !"@" $ oProcess:cTO
    ...
    oProcess:oHtml:valbyname('proc_link',GetNewPar("MV_WFHTTP",cServerWf)+'/wf/workflow/messenger/'+'/emp'+ cEmpAnt + '/compras/' + alltrim(cProcess) + '.HTM' ) //Defino o Link onde foi gravado o HTML pelo Workflow,abaixo do diret๓rio do usuแrio definido em cTo do processo acima.
	  ...
	  oProcess:cBCC     := "igor-d-silva@hotmail.com" //C๓pia
